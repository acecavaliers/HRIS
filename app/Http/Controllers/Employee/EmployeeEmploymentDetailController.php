...
class EmployeeEmploymentDetailController extends Controller
{
    ...
    {
        return Inertia::render('Employee/EmployeeEmploymentDetail');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeEmploymentDetail', $request);

        $systemtable = SystemTable::where('table_name', 'employee_employment_details')->first();
        ...
        $query = EmployeeEmploymentDetail::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeEmploymentDetail::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeEmploymentDetail::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        EmployeeEmploymentDetail::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = EmployeeEmploymentDetail::with('employeestatuses','applicationsources', 'employees')->where('employee_id', $request->employee_id)->paginate($request->showrecords);
        return $query;
    ...
    public function searchData(Request $request){
        ...
        /*     return $request->is_active_all; */
            ...
            $val = 0;
            $query = EmployeeEmploymentDetail::query();
