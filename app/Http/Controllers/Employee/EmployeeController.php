...
class EmployeeController extends Controller
{
    ...
    {
        $validated = CommonController::getRequiredFields('Employee', $request);

        $systemtable = SystemTable::where('table_name', 'employees')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Employee::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Employee::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Employee::with('employeeeducations', 'employeedependents', 'employeefamilybackgrounds', 'employeeemploymentdetails', 'employeeemploymenthistories', 'employeeworkassignments')->paginate($request->showrecords);
        return $query;
    ...
    public function getEmployeeMain($managevalue, $empid = null){
        $empdata = Employee::where('id', $empid)->get();
