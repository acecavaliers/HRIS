...
class EmployeeDisciplinaryActionController extends Controller
{
    ...
    {
        return Inertia::render('Employee/EmployeeDisciplinaryAction');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeDisciplinaryAction', $request);

        $systemtable = SystemTable::where('table_name', 'employee_disciplinary_actions')->first();
        ...
        $query = EmployeeDisciplinaryAction::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeDisciplinaryAction::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeDisciplinaryAction::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        EmployeeDisciplinaryAction::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = EmployeeDisciplinaryAction::with('offensedetails')->paginate($request->showrecords);
        return $query;
    }
