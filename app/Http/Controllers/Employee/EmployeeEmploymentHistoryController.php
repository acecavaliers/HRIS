...
class EmployeeEmploymentHistoryController extends Controller
{
    ...
    {
        return Inertia::render('Employee/EmployeeEmploymentHistory');
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeEmploymentHistory', $request);

        $systemtable = SystemTable::where('table_name', 'employee_employment_histories')->first();
        ...
        $query = EmployeeEmploymentHistory::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeEmploymentHistory::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeEmploymentHistory::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        EmployeeEmploymentHistory::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request){
        ...
        $query = EmployeeEmploymentHistory::where('employee_id', $request->employee_id)->paginate($request->showrecords);
        return $query;
