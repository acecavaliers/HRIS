...
class EmployeeFamilyBackgroundController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Employee/EmployeeFamilyBackground');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeFamilyBackground', $request);
        $systemtable = SystemTable::where('table_name', 'employee_family_backgrounds')->first();
        ...
        $query = EmployeeFamilyBackground::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeFamilyBackground::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeFamilyBackground::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        EmployeeFamilyBackground::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = EmployeeFamilyBackground::with('relationships', 'employees')->where('employee_id', $request->employee_id)->paginate($request->showrecords);
        return $query;
    ...
    public function searchData(Request $request){
        ...
        /*     return $request->is_active_all; */
            ...
            $val = 0;
            $query = EmployeeFamilyBackground::query();
