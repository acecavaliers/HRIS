...
class EmployeeEducationController extends Controller
{
    ...
    {
        return Inertia::render('Employee/EmployeeEducation');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeEducation', $request);

        $systemtable = SystemTable::where('table_name', 'employee_education')->first();
        ...
        $query = EmployeeEducation::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeEducation::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeEducation::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = EmployeeEducation::with('employees', 'educations', 'educationlevels', 'schools', 'coursecategories', 'courses' )->where('employee_id', $request->employee_id)->paginate($request->showrecords);
        return $query;
