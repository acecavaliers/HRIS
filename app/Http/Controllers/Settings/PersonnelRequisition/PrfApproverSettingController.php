...
namespace App\Http\Controllers\Settings\PersonnelRequisition;
...
class PrfApproverSettingController extends Controller
{
   /**
    ...
    {
        return Inertia::render('Settings/PersonnelRequisition/PersonnelRequisitionApproverSettings');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('PrfApproverSetting', $request);

        $systemtable = SystemTable::where('table_name', 'prf_approver_settings')->first();
        ...
        $query = PrfApproverSetting::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = PrfApproverSetting::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        PrfApproverSetting::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        PrfApproverSetting::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = PrfApproverSetting::paginate($request->showrecords);
        return $query;
    ...
    public function searchData(Request $request){
        ...
        /*     return $request->is_active_all; */
            ...
            $val = 0;
            $query = PrfApproverSetting::query();
