...
class EmployeeStatusController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/EmployeeStatus');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeStatus', $request);

        $systemtable = SystemTable::where('table_name', 'employee_statuses')->first();
        ...
        $query = EmployeeStatus::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeStatus::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeStatus::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = EmployeeStatus::paginate($request->showrecords);
        return $query;
