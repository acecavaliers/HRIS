...
class EmployeeTypeController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/EmployeeType');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EmployeeType', $request);

        $systemtable = SystemTable::where('table_name', 'employee_types')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EmployeeType::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EmployeeType::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = EmployeeType::paginate($request->showrecords);
        return $query;
