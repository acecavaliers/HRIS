...
class IslandGroupController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/IslandGroup');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('IslandGroup', $request);

        $systemtable = SystemTable::where('table_name', 'island_groups')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = IslandGroup::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        IslandGroup::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        IslandGroup::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = IslandGroup::with('countries')->paginate($request->showrecords);
        return $query;
