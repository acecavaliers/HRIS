...
class JobPositionController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/JobPosition');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('JobPosition', $request);

        $systemtable = SystemTable::where('table_name', 'job_positions')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = JobPosition::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        JobPosition::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = JobPosition::paginate($request->showrecords);
        return $query;
