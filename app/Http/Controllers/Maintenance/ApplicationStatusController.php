...
class ApplicationStatusController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/ApplicationStatus');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('ApplicationStatus', $request);

        $systemtable = SystemTable::where('table_name', 'application_statuses')->first();
        ...
        $query = ApplicationStatus::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = ApplicationStatus::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        ApplicationStatus::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        ApplicationStatus::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = ApplicationStatus::paginate($request->showrecords);
        return $query;
