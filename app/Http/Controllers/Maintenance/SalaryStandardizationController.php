...
class SalaryStandardizationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/SalaryStandardization');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('SalaryStandardization', $request);
        $systemtable = SystemTable::where('table_name', 'salary_standardizations')->first();
        ...
        $query = SalaryStandardization::create($arr);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = SalaryStandardization::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        SalaryStandardization::where('id', $id)->update(['deleted_by' => Auth::user()->name]);
        SalaryStandardization::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request)
    {
        ...
        $query = SalaryStandardization::with('countries')->paginate(10);
        return $query;
    ...
    public function searchData(Request $request)
    {
        ...
        $val = 0;
        $query = SalaryStandardization::query();
