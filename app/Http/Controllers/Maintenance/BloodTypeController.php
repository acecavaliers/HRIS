...
class BloodTypeController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/BloodType');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('BloodType', $request);

        $systemtable = SystemTable::where('table_name', 'blood_types')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = BloodType::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        BloodType::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        BloodType::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request)
    {
        $query = BloodType::paginate($request->showrecords);
        return $query;
    }
