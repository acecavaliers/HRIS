...
class PrfReasonForReqController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/PrfReasonForReq');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('PrfReasonForReq', $request);

        $systemtable = SystemTable::where('table_name', 'prf_reason_for_reqs')->first();
        ...
        $query = PrfReasonForReq::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = PrfReasonForReq::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        PrfReasonForReq::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        PrfReasonForReq::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = PrfReasonForReq::paginate(10);
        return $query;
