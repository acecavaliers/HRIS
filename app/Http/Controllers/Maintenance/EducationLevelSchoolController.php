...
class EducationLevelSchoolController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/EducationLevelSchool');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EducationLevelSchool', $request);

        $systemtable = SystemTable::where('table_name', 'education_level_schools')->first();
        ...
        $query = EducationLevelSchool::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EducationLevelSchool::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EducationLevelSchool::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        EducationLevelSchool::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = EducationLevelSchool::with('educationlevels','schools')->paginate($request->showrecords);
        return $query;
    ...
    public function searchData(Request $request){
        ...
        /*     return $request->is_active_all; */
            ...
            $val = 0;
            $query = EducationLevelSchool::query();
