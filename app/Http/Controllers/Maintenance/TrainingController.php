...
class TrainingController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Training');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Training', $request);

        $systemtable = SystemTable::where('table_name', 'trainings')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Training::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Training::where('id',$id)->update(['deleted_by' => Auth::user()->name]);
    ...
    {
        $query = Training::paginate($request->showrecords);
        return $query;
    }
