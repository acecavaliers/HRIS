...
class DoctorController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Doctor');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Earning', $request);

        $systemtable = SystemTable::where('table_name', 'earnings')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Doctor::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Doctor::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Doctor::with('specializations','sub_specializations')->paginate(10);
        return $query;
