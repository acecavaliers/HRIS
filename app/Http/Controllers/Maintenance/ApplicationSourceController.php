...
class ApplicationSourceController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/ApplicationSource');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('ApplicationSource', $request);

        $systemtable = SystemTable::where('table_name', 'application_sources')->first();
        ...
        $query = ApplicationSource::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = ApplicationSource::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        ApplicationSource::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        ApplicationSource::where('id', $id)->delete();
        return 'success';
    }
    public function getlist(Request $request){

        $query = ApplicationSource::paginate($request->showrecords);
        return $query;
