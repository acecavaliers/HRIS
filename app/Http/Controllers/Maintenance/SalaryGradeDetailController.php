...
class SalaryGradeDetailController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/SalaryGradeDetail');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('SalaryGradeDetail', $request);
        $systemtable = SystemTable::where('table_name', 'salary_grade_details')->first();
        ...
        $query = SalaryGradeDetail::create($arr);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = SalaryGradeDetail::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        SalaryGradeDetail::where('id', $id)->update(['deleted_by' => Auth::user()->name]);
        SalaryGradeDetail::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request)
    {
        ...
        $query = SalaryGradeDetail::with('salarystandardizations','salarygrades')->paginate($request->showrecords);
        return $query;
