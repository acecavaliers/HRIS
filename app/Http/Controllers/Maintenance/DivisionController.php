...
class DivisionController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Division');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Division', $request);

        $systemtable = SystemTable::where('table_name', 'divisions')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Division::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Division::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Division::paginate($request->showrecords);
        return $query;
