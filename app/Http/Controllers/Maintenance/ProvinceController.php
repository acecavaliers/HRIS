...
class ProvinceController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Province');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Province', $request);

        $systemtable = SystemTable::where('table_name', 'provinces')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Province::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Province::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Province::with('regions')->paginate($request->showrecords);
        return $query;
    ...
    public function getactivelist(Request $request){
        ...
        $query =  Province::with('regions')->where(array('region_id' => $request->regionID, 'is_active' => 1))->get();
        return $query;
