...
use App\Models\InterviewMethod;
...
class InterviewMethodController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/InterviewMethod');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('InterviewMethod', $request);

        $systemtable = SystemTable::where('table_name', 'interview_methods')->first();
        ...
        $query = InterviewMethod::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = InterviewMethod::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        InterviewMethod::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        InterviewMethod::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = InterviewMethod::paginate($request->showrecords);
        return $query;
    }
