...
class ProficiencyController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Proficiency');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Proficiency', $request);
        $systemtable = SystemTable::where('table_name', 'proficiencies')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Proficiency::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Proficiency::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        Proficiency::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = Proficiency::paginate($request->showrecords);
        return $query;
