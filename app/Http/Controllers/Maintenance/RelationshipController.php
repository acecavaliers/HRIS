...
class RelationshipController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Relationship');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Relationship', $request);

        $systemtable = SystemTable::where('table_name', 'relationships')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Relationship::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Relationship::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Relationship::paginate($request->showrecords);
        return $query;
