...
class LanguageController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Language');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Language', $request);
        $systemtable = SystemTable::where('table_name', 'languages')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Language::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Language::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Language::paginate($request->showrecords);
        return $query;
