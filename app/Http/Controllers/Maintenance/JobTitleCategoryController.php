...
class JobTitleCategoryController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/JobTitleCategory');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('JobTitleCategory', $request);

        $systemtable = SystemTable::where('table_name', 'job_title_categories')->first();
        ...
        $query = JobTitleCategory::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = JobTitleCategory::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        JobTitleCategory::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        JobTitleCategory::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = JobTitleCategory::paginate($request->showrecords);
        return $query;
