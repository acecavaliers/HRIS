...
class SpecializationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Specialization');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Specialization', $request);

        $systemtable = SystemTable::where('table_name', 'specializations')->first();
        ...
        $query = Specialization::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Specialization::where('id',$id)->update($arr);
        return 'success';
    }
    ...
    {
        Specialization::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    {
        $query = Specialization::paginate($request->showrecords);
        return $query;
    }
