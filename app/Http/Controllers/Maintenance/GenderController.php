...
class GenderController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Gender');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Gender', $request);

        $systemtable = SystemTable::where('table_name', 'genders')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Gender::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Gender::where('id', $id)->update(['deleted_by' => Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Gender::paginate($request->showrecords);
        return $query;
