...
class OffenseController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Offense');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Offense', $request);
    
        $systemtable = SystemTable::where('table_name', 'offenses')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Offense::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Offense::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        Offense::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = Offense::paginate($request->showrecords);
        return $query;
