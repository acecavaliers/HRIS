...
class CourseCategoryController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/CourseCategory');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('CourseCategory', $request);

        $systemtable = SystemTable::where('table_name', 'course_categories')->first();
        ...
        $query = CourseCategory::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = CourseCategory::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        CourseCategory::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = CourseCategory::paginate($request->showrecords);
        return $query;
