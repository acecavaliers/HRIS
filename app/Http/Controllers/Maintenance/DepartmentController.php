...
class DepartmentController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Department');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Department', $request);

        $systemtable = SystemTable::where('table_name', 'departments')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Department::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Department::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Department::with('divisions')->paginate($request->showrecords);
        return $query;
