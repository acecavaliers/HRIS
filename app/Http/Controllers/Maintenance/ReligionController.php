...
class ReligionController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Religion');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Religion', $request);

        $systemtable = SystemTable::where('table_name', 'religions')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Religion::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Religion::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Religion::paginate($request->showrecords);
        return $query;
