...
class AllowanceController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Allowance');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Allowance', $request);

        $systemtable = SystemTable::where('table_name', 'allowances')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Allowance::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Allowance::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Allowance::paginate($request->showrecords);
        return $query;
