...
class NationalityController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Nationality');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Nationality', $request);

        $systemtable = SystemTable::where('table_name', 'nationalities')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Nationality::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Nationality::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Nationality::paginate($request->showrecords);
        return $query;
