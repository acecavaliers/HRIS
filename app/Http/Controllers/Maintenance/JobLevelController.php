...
class JobLevelController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/JobLevel');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('JobLevel', $request);

        $systemtable = SystemTable::where('table_name', 'job_levels')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = JobLevel::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        JobLevel::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = JobLevel::paginate($request->showrecords);
        return $query;
