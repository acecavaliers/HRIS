...
class OffenseDetailController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/OffenseDetail');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('OffenseDetail', $request);
        $systemtable = SystemTable::where('table_name', 'offense_details')->first();
        ...
        $query = OffenseDetail::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = OffenseDetail::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        OffenseDetail::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        OffenseDetail::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request){
        ...
        $query = OffenseDetail::with('offenses', 'offensecategories')->paginate($request->showrecords);
        return $query;
