...
class SubDepartmentController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/SubDepartment');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('SubDepartment', $request);

        $systemtable = SystemTable::where('table_name', 'sub_departments')->first();
        ...
        $query = SubDepartment::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = SubDepartment::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        SubDepartment::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = SubDepartment::with('departments')->paginate($request->showrecords);
        return $query;
