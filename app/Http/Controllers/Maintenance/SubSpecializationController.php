...
class SubSpecializationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/SubSpecialization');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('SubSpecialization', $request);

        $systemtable = SystemTable::where('table_name', 'sub_specializations')->first();
        ...
        $query = SubSpecialization::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = SubSpecialization::where('id',$id)->update($arr);
        return 'success';
    }
    ...
    {
        SubSpecialization::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        SubSpecialization::where('id'.$id)->delete();
        return 'success';
    }

    public function getlist(Request $request)
    {
        $query = SubSpecialization::with('specializations')->paginate($request->showrecords);
        return $query;
    }
