...
class RegionsController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Region');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = CommonController::getRequiredFields('Region', $request);

        $systemtable = SystemTable::where('table_name', 'regions')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Region::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Region::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Region::with(['countries', 'islandgroups'])->paginate($request->showrecords);
        return $query;
    ...
    public function getactivelist(Request $request){
        ...
        $query = Region::with(['countries', 'islandgroups'])->where(array('country_id' => $request->countryID, 'is_active' => 1))->get();
        return $query;
    ...
    public function searchData(Request $request){
        ...
        /*     return $request->is_active_all; */
            ...
            $data = $query->paginate($request->showrecords);
            return $data;
