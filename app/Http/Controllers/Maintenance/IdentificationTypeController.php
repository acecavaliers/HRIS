...
class IdentificationTypeController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/IdentificationType');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('IdentificationType', $request);

        $systemtable = SystemTable::where('table_name', 'identification_types')->first();
        ...
        $query = IdentificationType::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = IdentificationType::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        IdentificationType::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = IdentificationType::paginate($request->showrecords);
        return $query;
