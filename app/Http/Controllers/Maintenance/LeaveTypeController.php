...
class LeaveTypeController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/LeaveType');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('LeaveType', $request);

        $systemtable = SystemTable::where('table_name', 'leave_types')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = LeaveType::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        LeaveType::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = LeaveType::paginate($request->showrecords);
        return $query;
