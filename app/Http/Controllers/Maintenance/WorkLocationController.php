...
class WorkLocationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/WorkLocation');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('WorkLocation', $request);

        $systemtable = SystemTable::where('table_name', 'work_locations')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = WorkLocation::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        WorkLocation::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        WorkLocation::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request){
        ...
        $query = WorkLocation::with('countries', 'regions', 'provinces', 'cities','barangays')->paginate($request->showrecords);
        return $query;
