...
class CountriesController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Country');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = CommonController::getRequiredFields('Country', $request);

        $systemtable = SystemTable::where('table_name', 'countries')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Country::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Country::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Country::paginate($request->showrecords);
        return $query;

    }

    public function getactivelist(){
        $query = Country::where('is_active', 1)->get();
        return $query;
    }
