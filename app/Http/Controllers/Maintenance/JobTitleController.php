...
class JobTitleController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/JobTitle');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('JobTitle', $request);

        $systemtable = SystemTable::where('table_name', 'job_titles')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = JobTitle::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        JobTitle::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = JobTitle::with('joblevels', 'jobtitlecategories')->paginate($request->showrecords);
        return $query;
