...
class EducationLevelController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/EducationLevel');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('EducationLevel', $request);

        $systemtable = SystemTable::where('table_name', 'education_levels')->first();
        ...
        $query = EducationLevel::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = EducationLevel::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        EducationLevel::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = EducationLevel::with('educations')->paginate($request->showrecords);
        return $query;
