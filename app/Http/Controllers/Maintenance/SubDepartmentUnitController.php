...
class SubDepartmentUnitController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/SubDepartmentUnit');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('SubDepartmentUnit', $request);

        $systemtable = SystemTable::where('table_name', 'sub_department_units')->first();
        ...
        $query = SubDepartmentUnit::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = SubDepartmentUnit::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        SubDepartmentUnit::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        SubDepartmentUnit::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = SubDepartmentUnit::with('subdepartments')->paginate($request->showrecords);
        return $query;
