...
class HolidayTypeController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/HolidayType');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('HolidayType', $request);

        $systemtable = SystemTable::where('table_name', 'holiday_types')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = HolidayType::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        HolidayType::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        HolidayType::where('id', $id)->delete();
        return 'success';
    }
    ...
    public function getlist(Request $request){
        ...
        $query = HolidayType::paginate($request->showrecords);
        return $query;
