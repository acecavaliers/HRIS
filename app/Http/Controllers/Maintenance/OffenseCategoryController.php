...
class OffenseCategoryController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/OffenseCategory');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('OffenseCategory', $request);

        $systemtable = SystemTable::where('table_name', 'offense_categories')->first();
        ...
        $query = OffenseCategory::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = OffenseCategory::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        OffenseCategory::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        OffenseCategory::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = OffenseCategory::paginate($request->showrecords);
        return $query;
