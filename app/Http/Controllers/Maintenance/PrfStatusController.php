...
class PrfStatusController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/PrfStatus');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('PrfStatus', $request);

        $systemtable = SystemTable::where('table_name', 'prf_statuses')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = PrfStatus::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        PrfStatus::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        PrfStatus::where('id', $id)->delete();
        return 'success';
    }
