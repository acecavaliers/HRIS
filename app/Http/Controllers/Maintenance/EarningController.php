...
class EarningController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Earning');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Earning::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Earning::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Earning::paginate($request->showrecords);
        return $query;
