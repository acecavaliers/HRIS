...
class OffenseSeverityController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Maintenance/OffenseSeverity');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('OffenseSeverity', $request);

        $systemtable = SystemTable::where('table_name', 'offense_severities')->first();
        ...
        $query = OffenseSeverity::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = OffenseSeverity::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        OffenseSeverity::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        OffenseSeverity::where('id', $id)->delete();
        return 'success';
    }
    public function getlist(Request $request){

        $query = OffenseSeverity::paginate($request->showrecords);
        return $query;
