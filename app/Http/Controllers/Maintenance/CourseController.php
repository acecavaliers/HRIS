...
class CourseController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Course');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Course', $request);

        $systemtable = SystemTable::where('table_name', 'courses')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Course::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Course::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Course::with('coursecategories','educationlevels')->paginate($request->showrecords);
        return $query;
