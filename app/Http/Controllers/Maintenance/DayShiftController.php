...
class DayShiftController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/DayShift');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('DayShift', $request);

        $systemtable = SystemTable::where('table_name', 'day_shifts')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = DayShift::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        DayShift::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        DayShift::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = DayShift::with('workshifts')->paginate($request->showrecords);
        return $query;
