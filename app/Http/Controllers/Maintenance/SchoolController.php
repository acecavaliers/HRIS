...
class SchoolController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/School');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('School', $request);

        $systemtable = SystemTable::where('table_name', 'schools')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = School::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        School::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = School::with('cities')->paginate($request->showrecords);
        return $query;
