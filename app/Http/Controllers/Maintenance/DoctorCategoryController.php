...
class DoctorCategoryController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/DoctorCategory');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('DoctorCategory', $request);

        $systemtable = SystemTable::where('table_name', 'doctor_categories')->first();
        ...
        $query = DoctorCategory::create($arr);
        return 'success';
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = DoctorCategory::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        DoctorCategory::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
        DoctorCategory::where('id', $id)->delete();
        return 'success';
    }

    public function getlist(Request $request){

        $query = DoctorCategory::paginate($request->showrecords);
        return $query;
