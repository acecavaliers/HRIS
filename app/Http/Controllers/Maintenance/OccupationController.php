...
class OccupationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Occupation');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Occupation', $request);

        $systemtable = SystemTable::where('table_name', 'occupations')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Occupation::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Occupation::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Occupation::paginate($request->showrecords);
        return $query;
