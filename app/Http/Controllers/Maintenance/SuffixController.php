...
class SuffixController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Suffix');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Suffix', $request);

        $systemtable = SystemTable::where('table_name', 'suffixes')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Suffix::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Suffix::where('id',$id)->update(['deleted_by' => Auth::user()->name]);
    ...
    {
        $query = Suffix::paginate($request->showrecords);
        return $query;
    }
