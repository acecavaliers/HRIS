...
class EducationController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Education');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Education', $request);

        $systemtable = SystemTable::where('table_name', 'educations')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Education::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Education::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Education::paginate($request->showrecords);
        return $query;
