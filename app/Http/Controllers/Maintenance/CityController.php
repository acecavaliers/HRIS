...
class CityController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/City');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('City', $request);

        $systemtable = SystemTable::where('table_name', 'cities')->first();
    ...
    public function update(Request $request, string $id)
    {
       ...
       $validated = CommonController::getRequiredFields('City', $request);
        ...
        $query = City::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        City::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = City::with('provinces')->paginate($request->showrecords);
        return $query;
    ...
    public function getactivelist(Request $request){
        ...
        $query =  City::with('provinces')->where(array('province_id' => $request->provinceID, 'is_active' => 1))->get();
        return $query;
