...
class SkillController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/Skill');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('Skill', $request);

        $systemtable = SystemTable::where('table_name', 'skills')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = Skill::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        Skill::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = Skill::paginate($request->showrecords);
        return $query;
