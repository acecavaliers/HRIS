...
class CivilStatusController extends Controller
{
    ...
    {
        return Inertia::render('Maintenance/CivilStatus');
    }
    ...
    {
        $validated = CommonController::getRequiredFields('CivilStatus', $request);

        $systemtable = SystemTable::where('table_name', 'civil_statuses')->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $query = CivilStatus::where('id', $id)->update($arr);
        return 'success';
    }
    ...
    {
        CivilStatus::where('id', $id)->update(['deleted_by'=> Auth::user()->name]);
    ...
    public function getlist(Request $request){
        ...
        $query = CivilStatus::paginate($request->showrecords);
        return $query;
