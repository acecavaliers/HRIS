...
<template>
    <Head title="Employee Handbook" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Employee Handbook</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Employee Handbook" tabledescription="List of all employee handbooks" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeehandbooks.search" routename="employeehandbooks" formtitle="Employee Handbooks" :ismainsidebar=true :customaddbtn=false modelname="EmployeeHandbook">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('employeehandbooks.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('employeehandbooks.getcolumns'), {
            params:{
