...
<template>
    <Head title="JobPositions" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">JobPositions</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="JobPositions" tabledescription="List of all jobpositions" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="jobpositions.search" routename="jobpositions" formtitle="JobPosition" :ismainsidebar=true :customaddbtn=false modelname="JobPosition">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('jobpositions.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('jobpositions.getcolumns'), {
            params:{
