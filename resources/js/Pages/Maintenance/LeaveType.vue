...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">LeaveTypes</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="LeaveTypes" tabledescription="List of all leavetypes" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="leavetypes.search" routename="leavetypes" formtitle="LeaveType" :ismainsidebar=true :customaddbtn=false modelname="LeaveType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('leavetypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('leavetypes.getcolumns'), {
            params:{
