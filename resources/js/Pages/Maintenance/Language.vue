...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="Languages" tabledescription="List of all languages" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="languages.search" routename="languages" formtitle="Language" :ismainsidebar=true :customaddbtn=false modelname="Language">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('languages.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('languages.getcolumns'), {
            params:{
