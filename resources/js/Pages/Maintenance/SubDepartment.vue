...
<template>
    <Head title="SubDepartment" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Sub Department</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="SubDepartment" tabledescription="List of all SubDepartment" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="subdepartments.search" routename="subdepartments" formtitle="SubDepartment" :ismainsidebar=true :customaddbtn=false modelname="SubDepartment">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('subdepartments.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('subdepartments.getcolumns'), {
            params:{
