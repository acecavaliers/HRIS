...
<template>
    <Head title="Blood Type" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Blood Types</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Blood Type" tabledescription="List of all bloodtypes" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="bloodtypes.search" routename="bloodtypes" formtitle="BloodType" :ismainsidebar=true :customaddbtn=false modelname="BloodType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('bloodtypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('bloodtypes.getcolumns'), {
            params:{
