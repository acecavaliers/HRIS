...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Employment Type</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="EmploymentType" tabledescription="List of all EmploymentType" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employmenttypes.search" routename="employmenttypes" formtitle="EmploymentTypes" :ismainsidebar=true :customaddbtn=false modelname="EmploymentType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('employmenttypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('employmenttypes.getcolumns'), {
            params:{
