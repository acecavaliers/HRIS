...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Allowances</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Allowances" tabledescription="List of all allowances" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="allowances.search" routename="allowances" formtitle="Allowances" :ismainsidebar=true :customaddbtn=false modelname="Allowance">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('allowances.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('allowances.getcolumns'), {
            params:{
