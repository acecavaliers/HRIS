...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="Cities" tabledescription="List of all cities" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="cities.search" routename="cities" formtitle="City" :ismainsidebar=true :customaddbtn=false modelname="City">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('cities.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('cities.getcolumns'), {
            params:{
