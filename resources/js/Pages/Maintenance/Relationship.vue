...
<template>
    <Head title="Relationship" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Relationship</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Relationship" tabledescription="List of all Relationships" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="relationships.search" routename="relationships" formtitle="Relationships" :ismainsidebar=true :customaddbtn=false modelname="Relationship">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('relationships.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('relationships.getcolumns'), {
            params:{
