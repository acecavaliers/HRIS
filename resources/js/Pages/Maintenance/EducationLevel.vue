...
<template>
    <Head title="EducationLevel" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Education Level</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="EducationLevel" tabledescription="List of all educationlevels" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="educationlevels.search" routename="educationlevels" formtitle="EducationLevel" :ismainsidebar=true :customaddbtn=false modelname="EducationLevel">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('educationlevels.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('educationlevels.getcolumns'), {
            params:{
