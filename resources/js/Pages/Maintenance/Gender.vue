...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Gender</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Gender" tabledescription="List of all Gender" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="genders.search" routename="genders" formtitle="Genders" :ismainsidebar=true :customaddbtn=false modelname="Gender">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('genders.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('genders.getcolumns'), {
            params:{
