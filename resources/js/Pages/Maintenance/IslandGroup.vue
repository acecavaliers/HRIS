...
<template>
    <Head title="Island Groups" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Island Groups</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Island Groups" tabledescription="List of all Island Groups" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="islandgroups.search" routename="islandgroups" formtitle="Island Groups" :ismainsidebar=true :customaddbtn=false modelname="IslandGroup">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('islandgroups.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('islandgroups.getcolumns'), {
            params:{
