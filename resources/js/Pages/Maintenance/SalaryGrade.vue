...
<template>
    <Head title="Salary Grade" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Salary Grade</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Salary Grade" tabledescription="List of all salarygrades" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="salarygrades.search" routename="salarygrades" formtitle="salarygrades" :ismainsidebar=true :customaddbtn=false modelname="SalaryGrade">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('salarygrades.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('salarygrades.getcolumns'), {
            params:{
