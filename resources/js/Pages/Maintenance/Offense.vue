...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Offense</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Offense" tabledescription="List of all offenses" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="offenses.search" routename="offenses" formtitle="Offense" :ismainsidebar=true :customaddbtn=false modelname="Offense">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('offenses.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('offenses.getcolumns'), {
            params:{
