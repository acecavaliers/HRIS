...
<template>
    ...
    <MasterLayout>
        ...
        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Countries" tabledescription="List of all countries" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="countries.search" routename="countries" formtitle="Countries" :ismainsidebar=true :customaddbtn=false modelname="Country">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('countries.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('countries.getcolumns'), {
            params:{
