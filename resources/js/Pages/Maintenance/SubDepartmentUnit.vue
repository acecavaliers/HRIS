...
<template>
    <Head title="SubDepartmentUnit" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Sub Department Unit</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="SubDepartmentUnit" tabledescription="List of all SubDepartmentUnit" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="subdepartmentunits.search" routename="subdepartmentunits" formtitle="SubDepartmentUnit" :ismainsidebar=true :customaddbtn=false modelname="SubDepartmentUnit">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('subdepartmentunits.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('subdepartmentunits.getcolumns'), {
            params:{
