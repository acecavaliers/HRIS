...
<template>
    <Head title="Salary Standardization" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Salary Standardization</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Salary Standardization" tabledescription="List of all salarystandardizations" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="salarystandardizations.search" routename="salarystandardizations" formtitle="salarystandardizations" :ismainsidebar=true :customaddbtn=false modelname="SalaryStandardization">
...
export default {
    data(){
        return {
            ...
            model_name: 'SalaryStandardization',
            showrecordsval: 10,
        }
    },
    ...
    methods: {
        getData(){
            ...
            axios.get(route('salarystandardizations.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('salarystandardizations.getcolumns'), {
            params:{
