...
<template>
    <Head title="Event Type" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Event Type</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="EventType" tabledescription="List of all Event Types" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="eventtypes.search" routename="eventtypes" formtitle="EventTypes" :ismainsidebar=true :customaddbtn=false modelname="EventType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('eventtypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('eventtypes.getcolumns'), {
            params:{
