...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Religions</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Religion" tabledescription="List of all Religions" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="religions.search" routename="religions" formtitle="Religions" :ismainsidebar=true :customaddbtn=false modelname="Religion">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('religions.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('religions.getcolumns'), {
            params:{
