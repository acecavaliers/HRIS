...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="OffenseSeverity" tabledescription="List of all offenseseverities" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="offenseseverities.search" routename="offenseseverities" formtitle="offenseseverities" :ismainsidebar=true :customaddbtn=false modelname="OffenseSeverity">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('offenseseverities.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('offenseseverities.getcolumns'), {
            params:{
