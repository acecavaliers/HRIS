...
<template>
    <Head title="Code Of Discipline" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Code of Discipline</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Code Of Discipline" tabledescription="List of all Code Of Discipline" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="codeofdisciplines.search" routename="codeofdisciplines" formtitle="CodeOfDisciplines" :ismainsidebar=true :customaddbtn=false modelname="CodeOfDiscipline">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('codeofdisciplines.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('codeofdisciplines.getcolumns'), {
            params:{
