...
<template>
    <Head title="Offenses Classification" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Offenses Classification</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Offenses Classification" tabledescription="List of all Offenses Classification" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="offensesclassifications.search" routename="offensesclassifications" formtitle="OffensesClassification" :ismainsidebar=true :customaddbtn=false modelname="OffensesClassification">
...
export default {
    data(){
        return {
            ...
            model_name: 'OffensesClassification',
            showrecordsval: 10,
        }
    },
    ...
    methods: {
        getData(){
            ...
            axios.get(route('offensesclassifications.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('offensesclassifications.getcolumns'), {
            params:{
