...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Earning</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Earning" tabledescription="List of all earnings" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="earnings.search" routename="earnings" formtitle="Earning" :ismainsidebar=true :customaddbtn=false modelname="Earning">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('earnings.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('earnings.getcolumns'), {
            params:{
