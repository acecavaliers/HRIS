...
<template>
    ...
    <MasterLayout>
        ...
        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Holiday" tabledescription="List of all holidays" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="holidays.search" routename="holidays" formtitle="Holiday" :ismainsidebar=true :customaddbtn=false modelname="Holiday">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('holidays.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('holidays.getcolumns'), {
            params:{
