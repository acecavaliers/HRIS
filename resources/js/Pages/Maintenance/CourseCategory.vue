...
<template>
    <Head title="CourseCategories" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Course Category</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="CourseCategories" tabledescription="List of all coursecategories" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="coursecategories.search" routename="coursecategories" formtitle="CourseCategory" :ismainsidebar=true :customaddbtn=false modelname="CourseCategory">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('coursecategories.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('coursecategories.getcolumns'), {
            params:{
