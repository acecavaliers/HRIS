...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="Doctor" tabledescription="List of all doctors" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="doctors.search" routename="doctors" formtitle="Doctor" :ismainsidebar=true :customaddbtn=false modelname="Doctor">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('doctors.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('doctors.getcolumns'), {
            params:{
