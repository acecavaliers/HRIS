...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nationality</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Nationality" tabledescription="List of all Nationalities" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="nationalities.search" routename="nationalities" formtitle="Nationalities" :ismainsidebar=true :customaddbtn=false modelname="Nationality">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('nationalities.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('nationalities.getcolumns'), {
            params:{
