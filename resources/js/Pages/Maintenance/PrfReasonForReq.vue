...
<template>
    <Head title="PrfReasonForReqs" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Prf Reason For Req</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="PrfReasonForReqs" tabledescription="List of all prfreasonforreqs" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="prfreasonforreqs.search" routename="prfreasonforreqs" formtitle="PrfReasonForReqs" :ismainsidebar=true :customaddbtn=false modelname="PrfReasonForReq">
