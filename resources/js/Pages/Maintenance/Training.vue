...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Training And Development</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Training" tabledescription="List of all Training" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="trainings.search" routename="trainings" formtitle="Training" :ismainsidebar=true :customaddbtn=false modelname="Training">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('trainings.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('trainings.getcolumns'), {
            params:{
