...
<template>
    <Head title="PrfStatus" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">PrfStatus</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="PrfStatus" tabledescription="List of all prf_status" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="prfstatus.search" routename="prfstatus" formtitle="prfstatus" :ismainsidebar=true :customaddbtn=false modelname="PrfStatus">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('prfstatus.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('prfstatus.getcolumns'), {
            params:{
