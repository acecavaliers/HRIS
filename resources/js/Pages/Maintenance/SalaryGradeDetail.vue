...
<template>
    <Head title="Salary Grade Detail" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Salary Grade Detail</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Salary Grade Detail" tabledescription="List of all salarygradedetails" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="salarygradedetails.search" routename="salarygradedetails" formtitle="salarygradedetails" :ismainsidebar=true :customaddbtn=false modelname="SalaryGradeDetail">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('salarygradedetails.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('salarygradedetails.getcolumns'), {
            params:{
