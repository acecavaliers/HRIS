...
<template>
    <Head title="JobTitleCategory" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">JobTitleCategory</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="JobTitleCategory" tabledescription="List of all jobtitlecategories" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="jobtitlecategories.search" routename="jobtitlecategories" formtitle="JobTitleCategory" :ismainsidebar=true :customaddbtn=false modelname="JobTitleCategory">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('jobtitlecategories.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('jobtitlecategories.getcolumns'), {
            params:{
