...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Employee Status</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Employee Status" tabledescription="List of all employeestatuses" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeestatuses.search" routename="employeestatuses" formtitle="EmployeeStatus" :ismainsidebar=true :customaddbtn=false modelname="EmployeeStatus">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('employeestatuses.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('employeestatuses.getcolumns'), {
            params:{
