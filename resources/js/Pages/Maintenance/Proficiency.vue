...
<template>
    <Head title="Proficiency" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Proficiency</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Proficiency" tabledescription="List of all Proficiency" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="proficiencies.search" routename="proficiencies" formtitle="Proficiency" :ismainsidebar=true :customaddbtn=false modelname="Proficiency">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('proficiencies.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('proficiencies.getcolumns'), {
            params:{
