...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="Skills" tabledescription="List of all skills" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="skills.search" routename="skills" formtitle="Skill" :ismainsidebar=true :customaddbtn=false modelname="Skill">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('skills.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('skills.getcolumns'), {
            params:{
