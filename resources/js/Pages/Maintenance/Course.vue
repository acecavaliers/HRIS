...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Course </h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Courses" tabledescription="List of all courses" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="courses.search" routename="courses" formtitle="Courses" :ismainsidebar=true :customaddbtn=false modelname="Course">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('courses.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('courses.getcolumns'), {
            params:{
