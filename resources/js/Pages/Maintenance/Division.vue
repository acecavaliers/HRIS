...
<template>
    ...
    <MasterLayout>
        ...
        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Divisions" tabledescription="List of all divisions" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="divisions.search" routename="divisions" formtitle="Divisions" :ismainsidebar=true :customaddbtn=false modelname="Division">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('divisions.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('divisions.getcolumns'), {
            params:{
