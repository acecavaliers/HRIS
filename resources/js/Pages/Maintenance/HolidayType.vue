...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Holiday Type</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="HolidayType" tabledescription="List of all Holiday Types" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="holidaytypes.search" routename="holidaytypes" formtitle="HolidayTypes" :ismainsidebar=true :customaddbtn=false modelname="HolidayType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('holidaytypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('holidaytypes.getcolumns'), {
            params:{
