...
<template>
    <Head title="WorkLocation" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Work Location</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="WorkLocation" tabledescription="List of all WorkLocation" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="worklocations.search" routename="worklocations" formtitle="WorkLocation" :ismainsidebar=true :customaddbtn=false modelname="WorkLocation">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('worklocations.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('worklocations.getcolumns'), {
            params:{
