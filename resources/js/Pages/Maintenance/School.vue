...
<template>
    ...
    <MasterLayout>
        ...
        <AlertNotification></AlertNotification>
            <DataTable tabletitle="School" tabledescription="List of all schools" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="schools.search" routename="schools" formtitle="Schools" :ismainsidebar=true :customaddbtn=false modelname="School">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('schools.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('schools.getcolumns'), {
            params:{
