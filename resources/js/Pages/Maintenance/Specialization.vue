...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Specialization</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Specialization" tabledescription="List of all specializations" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="specializations.search" routename="specializations" formtitle="specializations" :ismainsidebar=true :customaddbtn=false modelname="Specialization">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('specializations.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('specializations.getcolumns'), {
            params:{
