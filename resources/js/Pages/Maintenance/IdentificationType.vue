...
<template>
    <Head title="Identification Type" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Identification Type</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="IdentificationType" tabledescription="List of all Identification Type" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="identificationtypes.search" routename="identificationtypes" formtitle="IdentificationType" :ismainsidebar=true :customaddbtn=false modelname="IdentificationType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('identificationtypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('identificationtypes.getcolumns'), {
            params:{
