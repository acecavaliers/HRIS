...
<template>
    <Head title="ApplicationSource" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Application Sources</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="ApplicationSource" tabledescription="List of all applicationsources" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="applicationsources.search" routename="applicationsources" formtitle="ApplicationSources" :ismainsidebar=true :customaddbtn=false modelname="ApplicationSource">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('applicationsources.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('applicationsources.getcolumns'), {
            params:{
