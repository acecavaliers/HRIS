...
<template>
    ...
    <MasterLayout>
        ...
        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Department" tabledescription="List of all departments" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="departments.search" routename="departments" formtitle="Departments" :ismainsidebar=true :customaddbtn=false modelname="Department">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('departments.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('departments.getcolumns'), {
            params:{
