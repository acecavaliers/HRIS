...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Occupations</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Occupations" tabledescription="List of all occupations" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="occupations.search" routename="occupations" formtitle="Occupations" :ismainsidebar=true :customaddbtn=false modelname="Occupation">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('occupations.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('occupations.getcolumns'), {
            params:{
