...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Barangays</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Barangays" tabledescription="List of all barangays" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="barangays.search" routename="barangays" formtitle="Barangay" :ismainsidebar=true :customaddbtn=false modelname="Barangay">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('barangays.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('barangays.getcolumns'), {
            params:{
