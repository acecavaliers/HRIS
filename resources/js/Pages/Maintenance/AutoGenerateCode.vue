...
<template>
    <Head title="AutoGenerateCode" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Auto Generate Code</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="AutoGenerateCode" tabledescription="List of all autogeneratecodes" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="autogeneratecodes.search" routename="autogeneratecodes" formtitle="AutoGenerateCode" :ismainsidebar=true :customaddbtn=false modelname="AutoGenerateCode">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('autogeneratecodes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('autogeneratecodes.getcolumns'), {
            params:{
