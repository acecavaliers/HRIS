...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="WorkShift" tabledescription="List of all WorkShift" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="workshifts.search" routename="workshifts" formtitle="WorkShift" :ismainsidebar=true :customaddbtn=false modelname="WorkShift">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('workshifts.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('workshifts.getcolumns'), {
            params:{
