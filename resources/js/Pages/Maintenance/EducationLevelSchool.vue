...
<template>
    <Head title="EducationLevelSchool" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Education Level School</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="EducationLevelSchool" tabledescription="List of all educationlevelschools" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="educationlevelschools.search" routename="educationlevelschools" formtitle="EducationLevelSchools" :ismainsidebar=true :customaddbtn=false modelname="EducationLevelSchool">
...
export default {
    data(){
        return {
            ...
            model_name: 'EducationLevelSchool',
            showrecordsval: 10,
        }
    },
    ...
    methods: {
        getData(){
            ...
            axios.get(route('educationlevelschools.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('educationlevelschools.getcolumns'), {
            params:{
