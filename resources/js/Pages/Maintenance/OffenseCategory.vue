...
<template>
    <Head title="Offense Category" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Offense Category</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="OffenseCategory" tabledescription="List of all offensecategories" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="offensecategories.search" routename="offensecategories" formtitle="offensecategories" :ismainsidebar=true :customaddbtn=false modelname="OffenseCategory">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('offensecategories.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('offensecategories.getcolumns'), {
            params:{
