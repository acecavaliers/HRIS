...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Suffix</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Suffix" tabledescription="List of all Suffix" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="suffixes.search" routename="suffixes" formtitle="Suffix" :ismainsidebar=true :customaddbtn=false modelname="Suffix">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('suffixes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('suffixes.getcolumns'), {
            params:{
