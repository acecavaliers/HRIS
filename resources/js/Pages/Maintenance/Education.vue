...
<template>
    ...
    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Education</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Education" tabledescription="List of all educations" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="educations.search" routename="educations" formtitle="Educations" :ismainsidebar=true :customaddbtn=false modelname="Education">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('educations.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('educations.getcolumns'), {
            params:{
