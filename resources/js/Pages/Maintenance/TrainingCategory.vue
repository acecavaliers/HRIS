...
<template>
    <Head title="Training And Development Categories" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Training And Development Categories</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="Training And Development Categories" tabledescription="List of all Training And Development Categories" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="trainingcategories.search" routename="trainingcategories" formtitle="TrainingCategory" :ismainsidebar=true :customaddbtn=false modelname="TrainingCategory">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('trainingcategories.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('trainingcategories.getcolumns'), {
            params:{
