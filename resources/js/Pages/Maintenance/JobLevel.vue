...
<template>
    <Head title="JobLevels" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">JobLevels</h2>
        </template>

        <AlertNotification></AlertNotification>

        <DataTable tabletitle="JobLevels" tabledescription="List of all joblevels" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="joblevels.search" routename="joblevels" formtitle="JobLevel" :ismainsidebar=true :customaddbtn=false modelname="JobLevel">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('joblevels.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('joblevels.getcolumns'), {
            params:{
