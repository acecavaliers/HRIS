...
<template>
    <Head title="Performance Type" />

    <MasterLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Performance Type</h2>
        </template>

        <AlertNotification></AlertNotification>
            <DataTable tabletitle="Performance Type" tabledescription="List of Performance Type" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="performancetypes.search" routename="performancetypes" formtitle="Performance Types" :ismainsidebar=true :customaddbtn=false modelname="PerformanceType">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('performancetypes.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('performancetypes.getcolumns'), {
            params:{
