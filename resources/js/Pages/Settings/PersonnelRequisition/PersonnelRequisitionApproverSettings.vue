<template>
    <div>
        ...
        <DataTable tabletitle="APPROVER SETTINGS" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="prfapproversettings.search" routename="prfapproversettings" formtitle="PRF APPROVER SETTINGS" :customaddbtn=false :ismainsidebar=false modelname="PrfApproverSetting" :datavaluesreferencedother="datavalues">
...
<script>
   ...
   methods: {
       getData(){
           ...
           axios.get(route('prfapproversettings.getlist'), {
            params: {
       ...
       getcolumns(){
           ...
           axios.get(route('prfapproversettings.getcolumns'), {
           params:{
