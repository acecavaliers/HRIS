...
<MasterLayout>
    <template #header>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Theme Color Settings</h2>
    </template>

    <AlertNotification></AlertNotification>
        <DataTable tabletitle="Theme Color Settings" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="themecolorsettings.search" routename="themecolorsettings" formtitle="Theme Color Settings" :ismainsidebar=true :customaddbtn=false modelname="ThemeColor">
...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get(route('themecolorsettings.getlist'),{
                params:{
        ...
        getcolumns(){
            ...
            axios.get(route('themecolorsettings.getcolumns'), {
            params:{
