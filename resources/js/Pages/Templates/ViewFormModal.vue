              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-7xl sm:p-6">
                <div class="sm:flex sm:items-start">
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <ViewFormModalContent :pageurl="pageurl" :datacontent="datacontent"></ViewFormModalContent>
                  </div>
                </div>
...
<script setup>
    ...
    import ViewFormModalContent from '@/Pages/Templates/ViewFormModalContent.vue';
...
<script>
    export default {
        ...
        created(){
            this.emitter.on('openviewForm', (evt) => {

                this.openmodal = true;
                this.pageurl = evt.pageurl
                this.datacontent = evt.datatoview
