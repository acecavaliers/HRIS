      ...
      <ol role="list" class="mx-auto flex w-full space-x-4 px-4 sm:px-6 lg:px-8">
        ...
        <li v-for="page in pages" :key="page.name" class="flex">
          <div class="flex items-center">
            ...
            <span v-else>
              <span class="ml-4 text-sm font-bold text-gray-500 hover:text-gray-700" :aria-current="page.current ? 'page' : undefined">{{ page.name }}</span>
            </span>
          </div>
        </li>
      </ol>
