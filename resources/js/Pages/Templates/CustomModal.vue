              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div>
                  ...
                  <div class="mt-3 text-center sm:mt-5">
                    <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">{{ modalTitle }}</DialogTitle>
                    <div class="mt-2">
...
export default {
    ...
    props: ['modalTitle', 'modalDescription', 'buttonText'],
    data(){
        return {
            open: false,
        }
    ...
    methods: {
        buttonFunction(){
            this.emitter.emit('customButtonFunction')
        }
    },
