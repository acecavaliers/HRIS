<template>
    <div>
        ...
        <DataTable tabletitle="EMPLOYEE IDENTIFICATION" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeeidentifications.search" routename="employeeidentifications" formtitle="Employee Identification" :customaddbtn=false :ismainsidebar=false modelname="EmployeeIdentification" :datavaluesreferencedother="datavalues">
...
<script>
   ...
   methods: {
       getData(){
           ...
           axios.get(route('employeeidentifications.getlist'), {
            params: {
       ...
       getcolumns(){
           ...
           axios.get(route('employeeidentifications.getcolumns'), {
           params:{
