<template>
    <div>
        ...
        <DataTable tabletitle="EMPLOYEE HISTORY" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeeemploymenthistories.search" routename="employeeemploymenthistories" formtitle="Employee Employment History" :customaddbtn=false :ismainsidebar=false modelname="EmployeeEmploymentHistory" :datavaluesreferencedother="datavalues">
...
<script>
   ...
   methods: {
       getData(){
           ...
           axios.get(route('employeeemploymenthistories.getlist'), {
            params: {
       ...
       getcolumns(){
           ...
           axios.get(route('employeeemploymenthistories.getcolumns'), {
           params:{
