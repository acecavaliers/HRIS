<template>
    <div>
        ...
        <DataTable tabletitle="EMPLOYEE DETAIL" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeeemploymentdetails.search" routename="employeeemploymentdetails" formtitle="Employee Employment Detail" :customaddbtn=false :ismainsidebar=false modelname="EmployeeEmploymentDetail" :datavaluesreferencedother="datavalues">
...
<script>
     export default {
       ...
       return {
           ...
           model_name: 'EmployeeEmploymentDetail',
           showrecordsval: 10,
   ...
   methods: {
       getData(){
           ...
           axios.get(route('employeeemploymentdetails.getlist'), {
            params: {
       ...
       getcolumns(){
           ...
           axios.get(route('employeeemploymentdetails.getcolumns'), {
           params:{
