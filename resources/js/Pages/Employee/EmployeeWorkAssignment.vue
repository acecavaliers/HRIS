<template>
    <div>
        ...
        <DataTable tabletitle="EMPLOYEE ASSIGNMENT" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeeworkassignments.search" routename="employeeworkassignments" formtitle="Employee Work Assignment" :customaddbtn=false :ismainsidebar=false modelname="EmployeeWorkAssignment" :datavaluesreferencedother="datavalues">
...
<script>
   ...
   methods: {
       getData(){
           ...
           axios.get(route('employeeworkassignments.getlist'),{
            params:{
       ...
       getcolumns(){
           ...
           axios.get(route('employeeworkassignments.getcolumns'), {
           params:{
