<template>
    <div>
        ...
        <DataTable tabletitle="EMPLOYEE FAMILY BACKGROUND" tabledescription="" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="employeefamilybackgrounds.search" routename="employeefamilybackgrounds" formtitle="Employee Family Background" :customaddbtn=false :ismainsidebar=false modelname="EmployeeFamilyBackground" :datavaluesreferencedother="datavalues">
...
<script>
     export default {
       ...
       return {
           ...
           model_name: 'EmployeeFamilyBackground',
           showrecordsval: 10,
   ...
   methods: {
       getData(){
           ...
           axios.get(route('employeefamilybackgrounds.getlist'), {
            params: {
       ...
       getcolumns(){
           ...
           axios.get(route('employeefamilybackgrounds.getcolumns'), {
           params:{
