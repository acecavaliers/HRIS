...
<template>
    ...
    <MasterLayout>
        ...
        <DataTable tabletitle="ShiftSetup" tabledescription="List of all ShiftSetup" :tabledata="data" :columns="columns" tablekeyname="id" columnkey="id" searchroutename="shiftsetup.search" routename="shiftsetup" formtitle="ShiftSetup" :ismainsidebar=true :customaddbtn=false modelname="ShiftSetup">
